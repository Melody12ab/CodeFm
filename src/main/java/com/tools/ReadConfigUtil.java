...
public class ReadConfigUtil {
    ...
    private String getTextLines() {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("读取mail.properties文件时，出现问题!");
        }
        return sb.toString();
    }

    public static void main(String args[]) {
//         ReadConfigUtil readConfig=new ReadConfigUtil("mail.properties",true);
//         System.out.println(readConfig.getValue("mail.from"));
    }
}
